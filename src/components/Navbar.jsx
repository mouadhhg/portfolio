  ...
  return (
    <nav className="fixed w-full bg-white/70 backdrop-blur-md border-b border-gray-100 z-50 transition-all duration-300">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        {/* Logo & Brand Name */}
        <a href="#home" className="flex items-center space-x-3 hover:scale-105 transition-transform">
          <img src={logo} alt="Logo" className="h-12 w-auto object-contain" />
          <span className="text-xl font-bold tracking-wider text-gray-900">
            Sharp <span className="text-blue-600">Code</span>
          </span>
        </a>
      ...
      <div className={`md:hidden bg-white/95 backdrop-blur-md overflow-hidden transition-all duration-300 ${isOpen ? 'max-h-60' : 'max-h-0'}`}>
        <div className="p-6 flex flex-col items-center space-y-6">
          ...
          <div className="flex space-x-6 pt-4 border-t w-full justify-center">
             <a href="https://www.instagram.com/sharp_edge_studio.dev?igsh=MTR4cGM1dmp1dXllMA==" className="text-gray-500 hover:text-pink-600"><FaInstagram size={22} /></a>
              <a href="https://www.tiktok.com/@sharpedgestudio?_r=1&_d=em96i73j02j4bi&sec_uid=MS4wLjABAAAA4Nc6Zp7aC-_E0YNNdGA_zrnwcr0AkXT061SqF1F6kKMSkkAiOBpjiLuRITAgMpNj&share_author_id=7667998371017786376&sharer_language=en&source=h5_m&u_code=f4khik3845lff3&timestamp=1785442492&user_id=7667998371017786376&sec_user_id=MS4wLjABAAAA4Nc6Zp7aC-_E0YNNdGA_zrnwcr0AkXT061SqF1F6kKMSkkAiOBpjiLuRITAlias=1&enable_checksum=1" className="text-gray-500 hover:text-black"><FaTiktok size={22} /></a>
             <a href="https://wa.me/212690231048" className="text-gray-500 hover:text-green-600"><FaWhatsapp size={22} /></a>
          </div>
        </div>
      </div>
    </nav>
